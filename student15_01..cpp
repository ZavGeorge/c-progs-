...
void findStudent(string searchName, string searchLastName) {
...
{
	cout << "Average ball for " << name << " " << last_name << " is " << average_score << endl;
	cout << "IdCard: " << iCard->getNumber() << endl;
	cout << "Category: " << iCard->getCategory() << endl;
}
